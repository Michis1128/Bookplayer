...
android {
    namespace = "com.michis.player.feature.settings"; compileSdk = 36; defaultConfig { minSdk = 26 }; buildFeatures { compose = true }
...
dependencies {
    ...
    implementation(libs.androidx.hilt.navigation.compose); implementation(libs.hilt.android); ksp(libs.hilt.compiler)
}
