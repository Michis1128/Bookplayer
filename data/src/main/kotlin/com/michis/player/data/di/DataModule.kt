...
import com.michis.player.data.local.MIGRATION_3_4
...
object DatabaseModule {
    @Provides @Singleton fun provideDatabase(@ApplicationContext context: Context): MichisPlayerDatabase =
        Room.databaseBuilder(context, MichisPlayerDatabase::class.java, "michis-player.db").addMigrations(MIGRATION_1_2, MIGRATION_2_3, MIGRATION_3_4).build()
